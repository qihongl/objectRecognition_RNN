...
data.mean.rep = zeros(size(data_sub{1}.mean.rep));
...
for i = 1 : numel(data_sub)
    ...
    data.mean.rep = data.mean.rep + data_sub{i}.mean.rep; 
...
data.mean.rep = data.mean.rep / numel(data_sub); 
...
data.sd.rep = zeros(size(data_sub{1}.mean.rep));
